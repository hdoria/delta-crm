			...
			<SheetContent side="right">
				...
				>
					<FieldGroup>
						...
						<Field>
							<FieldLabel htmlFor={emailId}>{t("create.email")}</FieldLabel>
							<Input
								id={emailId}
								type="email"
								value={email}
						...
						<Field>
							<FieldLabel htmlFor={titleId}>{t("create.title")}</FieldLabel>
							<Input
								id={titleId}
								value={title}
						...
						<Field>
							...
							<CompanyPicker
								...
								none={{ value: NONE, label: t("create.noCompany") }}
							/>
						</Field>
						...
						<Field>
							...
							<Select value={ownerId} onValueChange={setOwnerId}>
								...
								<SelectContent>
									<SelectItem value={NONE}>{t("create.unassigned")}</SelectItem>
									{(users.data ?? []).map((user) => (
