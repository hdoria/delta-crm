...
export function ArchiveRetention() {
	const t = useTranslations("settings.archiveRetention");
	const trpc = useTRPC();
		...
		<Card>
			...
			<CardContent>
				...
				>
					<FieldGroup>
						<Field>
							<FieldLabel htmlFor={daysId}>{t("pruneLabel")}</FieldLabel>
							<Input
								id={daysId}
								inputMode="numeric"
								value={draft}
							...
							/>
							<FieldDescription>{t("daysDescription")}</FieldDescription>
						</Field>
					</FieldGroup>
				</form>
			</CardContent>
