...
export function SettingsSidebarFallback() {
	...
	const items: SettingsNavItem[] = [
		{ title: t("general"), href: ROOT },
		{ title: t("tracking"), href: `${ROOT}/tracking` },
		{ title: t("connections"), href: `${ROOT}/connections` },
		{ title: t("currencies"), href: `${ROOT}/currencies` },
		{ title: t("members"), href: `${ROOT}/members` },
	];
...
export function SettingsSidebar() {
	...
	const items = useMemo(
		() =>
			...
			).map((item) => ({ ...item, href: workspaceUrl(item.href) })),
		[workspaceUrl, t],
	);
