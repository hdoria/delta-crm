...
const SOURCE_KEYS = {
	calendar: {
		labelKey: "sourceCalendarLabel",
		autoCreateKey: "sourceCalendarAutoCreate",
	},
	gmail: {
		labelKey: "sourceGmailLabel",
		autoCreateKey: "sourceGmailAutoCreate",
	},
} as const;
...
function GoogleUnavailable() {
	const t = useTranslations("settings.connections.google");
	...
	return (
		<Card>
			...
			<CardContent>
					...
					failing.map((source) => {
						...
						return (
							...
							>
								...
								<AlertTitle>
									{t("syncFailedTitle", {
										source: t(SOURCE_KEYS[source.source].labelKey),
									})}
								</AlertTitle>
				...
				{sources.map((source) => {
					const copy = SOURCE_KEYS[source.source];
