...
const TOGGLES = [
	{
		...
		labelKey: "subdomainsLabel",
		hintKey: "subdomainsHint",
	},
	{ flag: "secureCookies", labelKey: "secureLabel", hintKey: "secureHint" },
	{ flag: "honourDnt", labelKey: "dntLabel", hintKey: "dntHint" },
] as const;

export function TrackingCookies() {
	const t = useTranslations("settings.tracking.cookies");
	const trpc = useTRPC();
