...
export function TrackingScript() {
	const t = useTranslations("settings.tracking.script");
	const trpc = useTRPC();
			...
			<CardContent>
				...
				>
					<AccordionItem value="html">
						<AccordionTrigger>{t("htmlTab")}</AccordionTrigger>
					...
					<AccordionItem value="gtm">
						<AccordionTrigger>{t("gtmTab")}</AccordionTrigger>
						<AccordionContent className="flex flex-col gap-4">
							<pre className="overflow-x-auto rounded-md border bg-muted p-4 font-mono text-code-foreground text-xs/5">
								<span className="text-code-accent">{"<script"}</span>
								{"\n  src="}
				...
				<div className="flex items-center justify-between gap-6">
					...
					>
						<span className="text-sm">{t("pauseLabel")}</span>
