...
function AgentCodeWorkspaceSurface({
	...
	const t = useTranslations("agentBuilder.codeWorkspace");
	...
	if (!hydrated || (resolvedTheme !== "light" && resolvedTheme !== "dark")) {
		return (
			<section
				aria-label={t("generatedFilesAria")}
				aria-busy="true"
