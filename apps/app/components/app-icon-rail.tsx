...
function RailLink({
	...
	const title = useTranslations("nav");
	return (
		<Tooltip>
			<TooltipTrigger asChild>
				...
				>
					...
					>
						...
						<span className="sr-only">{title(item.id)}</span>
					</Link>
				</Button>
			</TooltipTrigger>
			<TooltipContent side="right">{title(item.id)}</TooltipContent>
		</Tooltip>
	);
}
				...
				{inChat ? (
					...
					>
						<SheetHeader className="sr-only">
							<SheetTitle>{title("navigationAndChats")}</SheetTitle>
						</SheetHeader>
						<nav
							aria-label={title("primary")}
						...
						>
							<Button
								variant="ghost"
								size="icon"
								aria-label={title("closeNavigation")}
